...
class distribution extends Component {
    ...
    //统计
    tongji = (obj) => {
        return  Axios.post(HttpUrl+'data/distance/statistics',{
    ...
    search = () => {
        new Promise(resolve => {
            resolve(Axios.post(HttpUrl+'data/distance/select',{
        ...
        <div className="content statistic" >
            <Tabs type="card" onChange={ this.tabChange} >
                <TabPane tab="按地区" key="1">
                    <Common wrappedComponentRef={(form) => this.form = form} whatTime='long' orShowTime='false,shiduan'  onRef={this.onRef} btnList={this.state.btnList.includes('travelListA')}></Common>
                </TabPane>
                    ...
                    <div  className='content-title'>
                        <Form layout="inline">  
                            <div className='searchType' style={{width:'100%'}}>
                                ...
                                {
                                    this.state.btnList.includes('travelListB') ? 
            ...
            <div>
                <div  className='oprateHead'>
                    {
                        this.state.tabKey === '1' ?
                        (
                            this.state.btnList.includes('travelExportA') ?
                        ...
                        :(
                            this.state.btnList.includes('travelExportB') ?
                            <Button type="primary" className='btn' onClick={ this.export} ghost>
                                <img src={exports} alt="" />
                                导出
                            </Button>
               ...
               <div className='table' style={{border:'1px solid #EBEDF8',padding:'34px 0px',background:"#fff"}}>
                    <div style={{display:this.state.tabKey === '1' ? 'block' : 'none'}}>
                        ...
                        <div style={{width:'95%',textAlign:'right',marginTop:'20px'}}>总里程：{this.state.totalSum}km</div>
                    </div>
